...
##                    print ("bolas[ii]",bolas[ii][1])
    ##                if l[e][0]+88>=bolas[ii][0]>=l[e][0]:
                    ...
                    if l[e][0]+77>=bolas[ii][0] and bolas[ii][0]>=l[e][0]+8:
    ...
    ##                        print b
            ...
            ##                powerUp()
                ...
                elif (l[e][0]+85>=bolas[ii][0] and bolas[ii][0]>=l[e][0]+76) or (l[e][0]+7>=bolas[ii][0] and bolas[ii][0]>=l[e][0]):
##                    pygame.mixer.Sound.set_volume(1.0)
##                    pygame.mixer.Sound.play(hey)
                    hey.play()
##                    print "l",l[e][0]
