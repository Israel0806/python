...
ballImg1_1=pygame.image.load("Bolalvl1_1.png")
...
##   [736,40,1],[736,75,1],[736,110,1],[736,145,1],[736,180,1],[736,215,1]]
    while x<len(l):
        ...
        gameDisplay.blit(brickRojo,(l[x][0],l[x][1]))        
        x+=1
...
##                        e=len(l)+1
                ...
                elif (e[0]+83+radio>=bolas[ii][0]>=e[0]+83-radio+3) or (e[0]+radio>=bolas[ii][0]>=e[0]-radio+3):
##                    pygame.mixer.Sound.set_volume(1.0)
##                    pygame.mixer.Sound.play(hey)
                    hey.play()
##                    print "l",l[e][0]
...
##            print speed
            if Barra2==True:
                if cor_x+96>=bolas[i][0]>=cor_x-5 and bolas[i][1]==638:
                    speed[i][1]=-speed[i][1]
            elif Barra==False:
