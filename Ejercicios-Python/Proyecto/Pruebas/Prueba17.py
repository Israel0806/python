    ...
    for e in l:
        for ii in range(0,len(bolas)):
            if e[1]+31+radio>=bolas[ii][1]>=e[1]-radio:
                if e[0]+63-radio-8>=bolas[ii][0]>=e[0]+radio+8:
                    if l[ee][2]!=3:
                        l[ee][2]-=1
                    if l[ee][2]==0:
                        score+=10
            ...
            if e[1]+29+radio>=bolas[ii][1]>=e[1]-radio+2:
                if (e[0]+63+radio>=bolas[ii][0]>=e[0]+63-1) or (e[0]+radio>=bolas[ii][0]>=e[0]-1):
                    if l[ee][2]!=3:
                        l[ee][2]-=1
                    if l[ee][2]==0:
                        score+=10
