...
ballImg=pygame.image.load("C:\Users\Israel\Desktop\Bola2def.png")
...
##                    if l[ee][0]+85>=xx>=l[ee][0]-5 and l[ee][1]+40>=lasers[0]>=l[ee][1]-5:
                    if l[ee][0]+85>=xx>=l[ee][0]-5:
                        if l[ee][1]+40>=lasers[0]>=l[ee][1]-5:
                            lasers[0]=50000
                            l.pop(ee)
##                    if l[ee][0]+85>=xx+150>=l[ee][0]-5 and l[ee][1]+40>=lasers[1]>=l[ee][1]-5:
                    if l[ee][0]+85>=xx+150>=l[ee][0]-5:
                        if l[ee][1]+40>=lasers[1]>=l[ee][1]-5:
